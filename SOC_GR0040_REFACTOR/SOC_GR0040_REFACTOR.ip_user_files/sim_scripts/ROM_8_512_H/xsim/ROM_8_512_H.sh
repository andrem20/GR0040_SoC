...
#
# Script generated by Vivado on Sun Jan 25 11:50:16 WET 2026
# SW Build 6140274 on Wed May 21 22:58:25 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : ROM_8_512_H.sh
...
#
# Usage        : ROM_8_512_H.sh
#                ROM_8_512_H.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ROM_8_512_H.sh [-reset_run]
#                ROM_8_512_H.sh [-reset_log]
#                ROM_8_512_H.sh [-help]
#
...
# script info
echo -e "ROM_8_512_H.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ROM_8_512_H.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L blk_mem_gen_v8_4_11 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ROM_8_512_H xil_defaultlib.ROM_8_512_H xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ROM_8_512_H -key {Behavioral:sim_1:Functional:ROM_8_512_H} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ROM_8_512_H.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ROM_8_512_H.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ROM_8_512_H.sh [-help]\n\
Usage: ROM_8_512_H.sh [-step]\n\
Usage: ROM_8_512_H.sh [-lib_map_path]\n\
Usage: ROM_8_512_H.sh [-reset_run]\n\
Usage: ROM_8_512_H.sh [-reset_log]\n\
Usage: ROM_8_512_H.sh [-keep_index]\n\
Usage: ROM_8_512_H.sh [-noclean_files]\n\n\
