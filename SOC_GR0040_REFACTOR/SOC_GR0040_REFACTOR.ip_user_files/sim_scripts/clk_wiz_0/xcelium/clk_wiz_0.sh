...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../ipstatic" +incdir+"../../../../../../../Vivado/2025.1/data/rsb/busdef" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../ipstatic" +incdir+"../../../../../../../Vivado/2025.1/data/rsb/busdef" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/mariana/Desktop/SOC_GR0040/SOC_GR0040_REFACTOR/SOC_GR0040_REFACTOR.cache/compile_simlib/xcelium"
  fi
