...
#
# Script generated by Vivado on Tue Jan 20 18:31:56 WET 2026
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../ipstatic" +incdir+"../../../../../../../Vivado/2025.1/data/rsb/busdef" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../ipstatic" +incdir+"../../../../../../../Vivado/2025.1/data/rsb/busdef" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/mariana/Desktop/SOC_GR0040/SOC_GR0040_REFACTOR/SOC_GR0040_REFACTOR.cache/compile_simlib/vcs"
  fi
