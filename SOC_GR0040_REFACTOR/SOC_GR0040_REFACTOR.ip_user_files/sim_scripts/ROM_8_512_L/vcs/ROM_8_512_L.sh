...
#                script (type 'ROM_8_512_L.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ROM_8_512_L xil_defaultlib.glbl -o ROM_8_512_L_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ROM_8_512_L_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key ROM_8_512_L_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ROM_8_512_L_simv.daidir vcs_lib c.obj)
