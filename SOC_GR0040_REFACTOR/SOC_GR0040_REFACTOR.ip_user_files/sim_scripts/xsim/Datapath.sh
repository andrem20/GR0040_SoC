...
#
# Script generated by Vivado on Thu Dec 04 16:51:31 WET 2025
...
#
# Usage        : Datapath.sh
#                Datapath.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Datapath.sh [-reset_run]
#                Datapath.sh [-reset_log]
#                Datapath.sh [-help]
#
...
# script info
echo -e "Datapath.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Datapath.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xpm -L dist_mem_gen_v8_0_17 -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot Datapath xil_defaultlib.Datapath xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Datapath -key {Behavioral:sim_1:Functional:Datapath} -tclbatch cmd.tcl -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xpm dist_mem_gen_v8_0_17)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Datapath.wdb xsim.dir libdpi.so)
...
Usage: Datapath.sh [-step]\n\
Usage: Datapath.sh [-lib_map_path]\n\
Usage: Datapath.sh [-reset_run]\n\
Usage: Datapath.sh [-reset_log]\n\
Usage: Datapath.sh [-keep_index]\n\
