...
#                script (type 'regfile16x16.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.regfile16x16 xil_defaultlib.glbl -o regfile16x16_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./regfile16x16_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/andre/Documents/Processor/SOC_FULL/SOC_GR0040/SOC_GR0040_REFACTOR/SOC_GR0040_REFACTOR.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key regfile16x16_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc regfile16x16_simv.daidir vcs_lib c.obj)
