...
#
# Script generated by Vivado on Sat Dec 27 21:07:49 WET 2025
# SW Build 6140274 on Wed May 21 22:58:25 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : regfile16x16.sh
...
#
# Usage        : regfile16x16.sh
#                regfile16x16.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                regfile16x16.sh [-reset_run]
#                regfile16x16.sh [-reset_log]
#                regfile16x16.sh [-help]
#
...
# script info
echo -e "regfile16x16.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./regfile16x16.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L dist_mem_gen_v8_0_17 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot regfile16x16 xil_defaultlib.regfile16x16 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim regfile16x16 -key {Behavioral:sim_1:Functional:regfile16x16} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/andre/Vivado/2025.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb regfile16x16.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./regfile16x16.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: regfile16x16.sh [-help]\n\
Usage: regfile16x16.sh [-step]\n\
Usage: regfile16x16.sh [-lib_map_path]\n\
Usage: regfile16x16.sh [-reset_run]\n\
Usage: regfile16x16.sh [-reset_log]\n\
Usage: regfile16x16.sh [-keep_index]\n\
Usage: regfile16x16.sh [-noclean_files]\n\n\
