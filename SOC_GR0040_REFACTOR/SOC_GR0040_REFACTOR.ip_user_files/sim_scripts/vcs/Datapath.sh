...
#                script (type 'Datapath.sh -help' for more information).
#
...
compile()
{
  ...
  "../../../../../Project\\ FPGA/SOC_GR0040_REFACTOR/SOC_GR0040_REFACTOR.srcs/sources_1/new/ALU.v" \
  "../../../../../Project\\ FPGA/SOC_GR0040_REFACTOR/SOC_GR0040_REFACTOR.srcs/sources_1/new/Datapath.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/mariana/Desktop/Project"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key Datapath_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc Datapath_simv.daidir vcs_lib c.obj)
