...
#                script (type 'BRAM_8_512_H.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.BRAM_8_512_H xil_defaultlib.glbl -o BRAM_8_512_H_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./BRAM_8_512_H_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key BRAM_8_512_H_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc BRAM_8_512_H_simv.daidir vcs_lib c.obj)
