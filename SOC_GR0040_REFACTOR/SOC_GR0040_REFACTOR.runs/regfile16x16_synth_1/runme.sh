...
HD_PWD='/home/andre/Documents/Processor/SOC_FULL/SOC_GR0040/SOC_GR0040_REFACTOR/SOC_GR0040_REFACTOR.runs/regfile16x16_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log regfile16x16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source regfile16x16.tcl
